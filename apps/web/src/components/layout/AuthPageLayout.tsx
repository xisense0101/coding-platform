        ...
        <div className="w-full max-w-md">
          ...
          {showFooterLinks && (
            <div className="mt-8 text-center space-y-2 text-sm text-muted-foreground">
              {footerHelpText && footerHelpLink && (
                <div>
                  <Link href={footerHelpLink} className="hover:underline">
                    {footerHelpText}
                  </Link>
                </div>
              )}
